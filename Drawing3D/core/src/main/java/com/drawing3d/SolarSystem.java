...
public class SolarSystem extends ApplicationAdapter { 
    ...
    private final float EARTH_ORBIT_SPEED = 10f;    
    // degrees/sec 
    private final float MOON_ROTATION_SPEED = 5f;    
    // degrees/sec 
    private final float MOON_ORBIT_SPEED = 40f;      
    // degrees/sec 
