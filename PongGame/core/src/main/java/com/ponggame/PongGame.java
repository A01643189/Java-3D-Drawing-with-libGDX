...
public class PongGame extends ApplicationAdapter {
    ...
    private void resetBall() {
        ballX = Gdx.graphics.getWidth() / 2 - BALL_SIZE / 2;
        ballY = Gdx.graphics.getHeight() / 2 - BALL_SIZE / 2;
        ballSpeedX = 0;
        ballSpeedY = 0;
    ...
    private void resetGame() {
        player1Y = Gdx.graphics.getHeight() / 2 - PADDLE_HEIGHT / 2;
        player2Y = Gdx.graphics.getHeight() / 2 - PADDLE_HEIGHT / 2;
        player1Score = 0;
        player2Score = 0;
    ...
    private void draw() {
        ...
        shapeRenderer.rect(Gdx.graphics.getWidth() - PADDLE_OFFSET - PADDLE_WIDTH, player2Y, PADDLE_WIDTH,
                PADDLE_HEIGHT); // Player 2
        ...
        for (int i = 0; i < Gdx.graphics.getHeight(); i += CENTER_LINE_SEGMENT_HEIGHT + CENTER_LINE_GAP) {
            shapeRenderer.rect(Gdx.graphics.getWidth() / 2 - CENTER_LINE_WIDTH / 2, i, CENTER_LINE_WIDTH,
        ...
        if (isPaused) {
            ...
            font.draw(batch, "Press ESC to resume", Gdx.graphics.getWidth() / 2 - 100,
            ...
            font.draw(batch, "Press R to restart", Gdx.graphics.getWidth() / 2 - 100,
                    Gdx.graphics.getHeight() / 2 - 50);
        }
